...
- **Type**: `string`
- **Required**: Yes
- **Description**: Please provide the URL of the uploaded file,Image to remove background from. Supported formats: PNG, JPG, WEBP. Max 5MB, max 16MP, max dimension 4096px, min dimension 256px.
- **Max File Size**: 5MB
